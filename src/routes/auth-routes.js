...
import { login, registerUser, logoutUser, getCurrentUser, refreshAccessToken, verifyEmail, forgotPasswordRequest, resetPassword, changedPassword, resentEmailVerification } from "../controllers/auth-controller.js";
...
router.route("/forgot-password-request").post(userForgotPasswordValidator(), validate, forgotPasswordRequest)
